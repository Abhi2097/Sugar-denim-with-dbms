...
import com.niit.models.Order_items;
...
//to create beans
	...
	public DataSource getDataSource() {
	    ...
	    dataSource.setUrl("jdbc:h2:tcp://localhost/~/EcommerceWebsite");
	...
	public SessionFactory sessionFactory() {
		...
		Class classes[]=new Class[]{User.class,Product.class,Shipment_Address.class,Orders.class,Order_items.class,Login.class};//If product class is not yet created, remove this and add it later
